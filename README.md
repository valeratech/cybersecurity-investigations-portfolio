...
| 003 | [HR Webshell → AD Enum → LSASS Dump → Tunnel Pivot → SMB Exfil](cyber_range_investigations/003-hr-webshell-ad-enum-lsass-dump-tunnel-smb-exfil/README.md) | CyberDefenders | Complete | [Report](cyber_range_investigations/003-hr-webshell-ad-enum-lsass-dump-tunnel-smb-exfil/reports/final-report.md) | [Timeline](cyber_range_investigations/003-hr-webshell-ad-enum-lsass-dump-tunnel-smb-exfil/README.md#5-timeline-utc) | [IOCs](cyber_range_investigations/003-hr-webshell-ad-enum-lsass-dump-tunnel-smb-exfil/README.md#6-indicators-of-compromise-iocs) |
