...
- Loaded PCAP and reviewed alert logs in Zui / Suricata dashboard  
- Filtered events using: `event_type=alert`
- Counted `dest_ip` to identify high-volume suspicious destination  
- Filtered alerts to: `dest_ip==113[.]26[.]232[.]2`
- Counted `alert.signature` for selected destination  
- Followed TCP stream to inspect HTTP request/response behavior  

## Key Observations (From This Step)

- High-volume external destination identified: `113[.]26[.]232[.]2` over TCP port 80  
- Primary alert signatures associated with this destination:
...
- External IP `113[.]26[.]232[.]2` is highly suspicious and likely associated with command-and-control (C2) infrastructure  
- High volume of beacon-related alerts strongly indicates automated communication consistent with Cobalt Strike Beacon behavior  
- HTTP responses with zero content-length are consistent with beaconing check-in patterns  


## Notes

- VirusTotal lookup for `113[.]26[.]232[.]2` returned no detections at time of analysis  
- `notice` and `weird` logs were reviewed at a high level but not deeply analyzed during this step  
- Further validation is required through correlation with additional network artifacts and timeline reconstruction  
